...
export const TEMPLATES: DeckTemplate[] = [
    ...
    createOfficialTemplate('simple', 'Simple Clean', {
        borderColor: '#e2e8f0',
        borderWidth: 2,
        backgroundColor: '#ffffff',
    ...
    }, 'front', { category: 'Themed' }),

    createOfficialTemplate('golden_era', 'Golden Era', {
        borderColor: '#B8860B',
        borderWidth: 12,
    ...
    createOfficialTemplate('modern_blue', 'Modern Tech', {
        borderColor: '#0f172a',
        borderWidth: 10,
    ...
    createOfficialTemplate('eldritch_archive', 'Eldritch Archive', {
        borderColor: '#2e102e',
        borderWidth: 12,
    ...
    createOfficialTemplate('neon_data', 'Neon Cyber', {
        borderColor: '#050505',
        borderWidth: 10,
    ...
    createOfficialTemplate('pocket_monster', 'Monster Card', {
        borderColor: '#f59e0b',
        borderWidth: 12,
    ...
    createOfficialTemplate('empty', 'Empty Canvas', {
        borderColor: '#e2e8f0',
        borderWidth: 1,
        backgroundColor: '#ffffff',
